...
#
#	if $VBoxContainer/dialogue/label.text == "":
...
var text = []
var actualText = 0
var charTextSize # Armazenar o número de caracteres do texto.
...
func _ready():
	#	# Definir a cena atual
	actualScene = scene1
	text.append(actualScene.lawExplanation)
